...
abstract class AppLocalizations {
  ...
  /// No description provided for @incidentsNearby.
  ///
  /// In pt, this message translates to:
  /// **'Incidentes próximos'**
  String get incidentsNearby;
  ...
  ///
  /// In pt, this message translates to:
  /// **'Iniciar rota (ETA ao vivo)'**
  String get startRoute;

  /// No description provided for @fillLastRoute.
  ///
  /// In pt, this message translates to:
  /// **'Preencher com última rota'**
  String get fillLastRoute;
