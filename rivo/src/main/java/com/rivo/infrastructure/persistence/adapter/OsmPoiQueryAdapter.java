...
import com.rivo.infrastructure.persistence.entity.OsmPoiEntity;
import com.rivo.infrastructure.persistence.repository.OsmPoiRepository;
...
/**
 * Implementa????o de {@link PoiQueryPort} usando geo.osm_pois (V004).
 * Sem??foros (TRAFFIC_LIGHT) no OSM v??m de highway=traffic_signals em geo.osm_other.
 */
@Component
