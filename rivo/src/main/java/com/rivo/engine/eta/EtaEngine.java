...
public class EtaEngine {
    ...
    /**
     * Atualiza o ETA com a velocidade observada (reportada pelo ve??culo).
     *
     * @param observedSpeedMps velocidade em m/s vinda do evento de localiza????o (LocationUpdatedEvent.speedMps).
     *                         Obrigat??ria: sem ela o ETA n??o reflete a velocidade real do ve??culo.
     */
